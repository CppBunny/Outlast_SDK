...
// 0x000C OR 0x00BC (0x00BC - 0x00B0)
// 12 OR 188 (188 - 176)
...
public:
	...
	uint32_t                                           bFakeMobileTouches : 1;                        // 0x00B8 (0x0004) [0x0000000000000000] [0x00000001] 
...
// 0x0184 OR 0x01E4 (0x01E4 - 0x0060)
// 388 OR 484 (484 - 96)
...
public:
	...
	uint32_t                                           bMovieIsOpen : 1;                              // 0x0114 (0x0004) [0x0000000000000002] [0x00000001] (CPF_Const)
	uint32_t                                           bDisplayWithHudOff : 1;                        // 0x0114 (0x0004) [0x0000000000000000] [0x00000002] 
	uint32_t                                           bEnableGammaCorrection : 1;                    // 0x0114 (0x0004) [0x0000000000000000] [0x00000004] 
	uint32_t                                           bWidgetsInitializedThisFrame : 1;              // 0x0114 (0x0004) [0x0000000000002002] [0x00000008] (CPF_Const | CPF_Transient)
	uint32_t                                           bLogUnhandedWidgetInitializations : 1;         // 0x0114 (0x0004) [0x0000000000000000] [0x00000010] 
	uint32_t                                           bAllowInput : 1;                               // 0x0114 (0x0004) [0x0000000000000000] [0x00000020] 
	uint32_t                                           bAllowFocus : 1;                               // 0x0114 (0x0004) [0x0000000000000000] [0x00000040] 
	uint32_t                                           bAutoPlay : 1;                                 // 0x0114 (0x0004) [0x0000000000000000] [0x00000080] 
	uint32_t                                           bPauseGameWhileActive : 1;                     // 0x0114 (0x0004) [0x0000000000000000] [0x00000100] 
	uint32_t                                           bDisableWorldRendering : 1;                    // 0x0114 (0x0004) [0x0000000000000000] [0x00000200] 
	uint32_t                                           bCaptureWorldRendering : 1;                    // 0x0114 (0x0004) [0x0000000000000000] [0x00000400] 
	uint32_t                                           bCloseOnLevelChange : 1;                       // 0x0114 (0x0004) [0x0000000000000000] [0x00000800] 
	uint32_t                                           bOnlyOwnerFocusable : 1;                       // 0x0114 (0x0004) [0x0000000000000000] [0x00001000] 
	uint32_t                                           bForceFullViewport : 1;                        // 0x0114 (0x0004) [0x0000000000000000] [0x00002000] 
	uint32_t                                           bDiscardNonOwnerInput : 1;                     // 0x0114 (0x0004) [0x0000000000000000] [0x00004000] 
	uint32_t                                           bCaptureInput : 1;                             // 0x0114 (0x0004) [0x0000000000000000] [0x00008000] 
	uint32_t                                           bCaptureMouseInput : 1;                        // 0x0114 (0x0004) [0x0000000000000000] [0x00010000] 
	uint32_t                                           bIgnoreMouseInput : 1;                         // 0x0114 (0x0004) [0x0000000000000000] [0x00020000] 
	uint32_t                                           bIsSplitscreenLayoutModified : 1;              // 0x0114 (0x0004) [0x0000000000002000] [0x00040000] (CPF_Transient)
	uint32_t                                           bShowHardwareMouseCursor : 1;                  // 0x0114 (0x0004) [0x0000000000000000] [0x00080000] 
	uint32_t                                           bBlurLesserMovies : 1;                         // 0x0114 (0x0004) [0x0000000000000000] [0x00100000] 
	uint32_t                                           bHideLesserMovies : 1;                         // 0x0114 (0x0004) [0x0000000000000000] [0x00200000] 
	uint32_t                                           bIsPriorityBlurred : 1;                        // 0x0114 (0x0004) [0x0000000000000000] [0x00400000] 
	uint32_t                                           bIsPriorityHidden : 1;                         // 0x0114 (0x0004) [0x0000000000000000] [0x00800000] 
	uint32_t                                           bIgnoreVisibilityEffect : 1;                   // 0x0114 (0x0004) [0x0000000000000000] [0x01000000] 
	uint32_t                                           bIgnoreBlurEffect : 1;                         // 0x0114 (0x0004) [0x0000000000000000] [0x02000000] 
	...
	EGFxTimingMode                                     TimingMode;                                    // 0x016C (0x0001) [0x0000000000000000]               
	EGFxRenderTextureMode                              RenderTextureMode;                             // 0x016D (0x0001) [0x0000000000000000]               
...
// 0x004C OR 0x00EC (0x00EC - 0x00A0)
// 76 OR 236 (236 - 160)
...
public:
	...
	EFlashTextureRescale                               TextureRescale;                                // 0x00B8 (0x0001) [0x0000000000000001] (CPF_Edit)    
...
public:
	...
	uint32_t                                           bUnload : 1;                                   // 0x0158 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
...
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0150 (0x0008) [0x0000000000000000]               
	class FString                                      Variable;                                      // 0x0158 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
// 0x0028 OR 0x0178 (0x0178 - 0x0150)
// 40 OR 376 (376 - 336)
class UGFxAction_Invoke : public USequenceAction
{
public:
	class UGFxMoviePlayer*                             Movie;                                         // 0x0150 (0x0008) [0x0000000000000000]               
	class FString                                      MethodName;                                    // 0x0158 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
// 0x0048 OR 0x0198 (0x0198 - 0x0150)
// 72 OR 408 (408 - 336)
...
public:
	...
	uint32_t                                           bTakeFocus : 1;                                // 0x0168 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bCaptureInput : 1;                             // 0x0168 (0x0004) [0x0000000000000001] [0x00000002] (CPF_Edit)
	uint32_t                                           bStartPaused : 1;                              // 0x0168 (0x0004) [0x0000000000000001] [0x00000004] (CPF_Edit)
	uint32_t                                           bEnableGammaCorrection : 1;                    // 0x0168 (0x0004) [0x0000000000000000] [0x00000008] 
	uint32_t                                           bDisplayWithHudOff : 1;                        // 0x0168 (0x0004) [0x0000000000000001] [0x00000010] (CPF_Edit)
	uint32_t                                           bMovieStarted : 1;                             // 0x0168 (0x0004) [0x0000000000000000] [0x00000020] 
	EGFxRenderTextureMode                              RenderTextureMode;                             // 0x016C (0x0001) [0x0000000000000001] (CPF_Edit)    
...
// 0x0020 OR 0x0190 (0x0190 - 0x0170)
// 32 OR 400 (400 - 368)
class UGFxEvent_FSCommand : public USequenceEvent
{
public:
	class USwfMovie*                                   Movie;                                         // 0x0170 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class FString                                      FSCommand;                                     // 0x0178 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
