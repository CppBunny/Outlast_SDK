...
struct FAchievementDetails
{
	...
	uint32_t                                           bIsSecret : 1;                                 // 0x0044 (0x0004) [0x0000000000000002] [0x00000001] (CPF_Const)
	uint32_t                                           bWasAchievedOnline : 1;                        // 0x0044 (0x0004) [0x0000000000000002] [0x00000002] (CPF_Const)
	uint32_t                                           bWasAchievedOffline : 1;                       // 0x0044 (0x0004) [0x0000000000000002] [0x00000004] (CPF_Const)
};
...
struct FCommunityContentFile
{
	...
	struct FUniqueNetId                                Owner;                                         // 0x0010 (0x0010) [0x0000000000000000]               
	int32_t                                            DownloadCount;                                 // 0x0020 (0x0004) [0x0000000000000000]               
	float                                              AverageRating;                                 // 0x0024 (0x0004) [0x0000000000000000]               
	int32_t                                            RatingCount;                                   // 0x0028 (0x0004) [0x0000000000000000]               
	int32_t                                            LastRatingGiven;                               // 0x002C (0x0004) [0x0000000000000000]               
	class FString                                      LocalFilePath;                                 // 0x0030 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FBaseAuthSession
{
	...
	struct FUniqueNetId                                EndPointUID;                                   // 0x0008 (0x0010) [0x0000000000000002] (CPF_Const)   
};
...
{
	uint8_t                                            AuthStatus;                                    // 0x0018 (0x0001) [0x0000000000000002] (CPF_Const)   
	int32_t                                            AuthTicketUID;                                 // 0x001C (0x0004) [0x0000000000000002] (CPF_Const)   
};
...
{
	int32_t                                            SessionUID;                                    // 0x0018 (0x0004) [0x0000000000000002] (CPF_Const)   
};
...
struct FLightingChannelContainer
{
	...
	uint32_t                                           Dynamic01 : 1;                                 // 0x0000 (0x0004) [0x0000000000000001] [0x00020000] (CPF_Edit)
	uint32_t                                           Dynamic02 : 1;                                 // 0x0000 (0x0004) [0x0000000000000001] [0x00040000] (CPF_Edit)
	uint32_t                                           Dynamic03 : 1;                                 // 0x0000 (0x0004) [0x0000000000000001] [0x00080000] (CPF_Edit)
	uint32_t                                           Dynamic04 : 1;                                 // 0x0000 (0x0004) [0x0000000000000001] [0x00100000] (CPF_Edit)
	uint32_t                                           Dynamic05 : 1;                                 // 0x0000 (0x0004) [0x0000000000000001] [0x00200000] (CPF_Edit)
...
{
	uint32_t                                           bOverride_Scene_TonemapperScale : 1;           // 0x0000 (0x0004) [0x0000000000000000] [0xFFFFFFFF80000000] 
	...
	struct FMobilePostProcessSettings                  MobilePostProcess;                             // 0x012C (0x0034) [0x0000000200000001] (CPF_Edit)    
};
...
struct FTexture2DMipMap
{
	...
	int32_t                                            SizeX;                                         // 0x0040 (0x0004) [0x0000000000001000] (CPF_Native)  
	int32_t                                            SizeY;                                         // 0x0044 (0x0004) [0x0000000000001000] (CPF_Native)  
};
...
struct FPostProcessSettingsOverride
{
	...
	uint32_t                                           bBlendingIn : 1;                               // 0x0160 (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           bBlendingOut : 1;                              // 0x0160 (0x0004) [0x0000000000000000] [0x00000002] 
